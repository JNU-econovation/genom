...
public class KingSetDirNode : Node
{
    ...
    public KingSetDirNode(GameObject pon, GameObject player, GameObject ponPivot, GameObject FindPivot1, GameObject FindPivot2)
    {
        this.pon = pon;
        this.player = player;
