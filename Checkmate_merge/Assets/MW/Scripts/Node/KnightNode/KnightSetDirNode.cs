...
public class KnightSetDirNode : Node
{
    ...
    public override NodeState Evaluate()
    {
        ...
        if ((Mathf.Abs(player.transform.position.y - knight.transform.position.y) / Mathf.Abs(player.transform.position.x - knight.transform.position.x) ) <
            2.2f && (Mathf.Abs(player.transform.position.y - knight.transform.position.y) / Mathf.Abs(player.transform.position.x - knight.transform.position.x)) > 1.9 && Vector3.Distance(player.transform.position, knight.transform.position) <2.7f)
        {
    ...
    0.7f && (Mathf.Abs(player.transform.position.y - knight.transform.position.y) / Mathf.Abs(player.transform.position.x - knight.transform.position.x)) > 0.4f && Vector3.Distance(player.transform.position, knight.transform.position) < 2.7f)
        {
